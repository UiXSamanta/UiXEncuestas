import svgPaths from "./svg-z563o35es8";

function Text() {
  return (
    <div className="bg-[#f3f4f6] relative rounded-[16777200px] shrink-0 size-[28px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[18px] not-italic relative shrink-0 text-[#6a7282] text-[12px] whitespace-nowrap">12</p>
      </div>
    </div>
  );
}
...
function Heading() {
  return (
    <div className="flex-[640.18_0_0] h-[19.25px] min-w-px relative" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[19.25px] left-0 not-italic text-[#101828] text-[14px] top-0 tracking-[-0.1504px] whitespace-nowrap">Nueva pregunta score-matrix</p>
      </div>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="h-[19.5px] relative shrink-0 w-[63.375px]" data-name="Container">
  ...
  return (
    <div className="relative size-[96px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 96 96">
        <g clipPath="url(#clip0_521_8186)" id="Icon">
          <path d={svgPaths.p30d75d80} id="Vector" stroke="var(--stroke-0, #E5E7EB)" strokeWidth="8.4" />
          <path d={svgPaths.p30d75d80} id="Vector_2" stroke="var(--stroke-0, #FDC700)" strokeLinecap="round" strokeWidth="8.4" />
        </g>
        <defs>
          <clipPath id="clip0_521_8186">
...
function Text19() {
  return (
    <div className="h-[28px] relative shrink-0 w-[27.742px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[#101828] text-[18px] top-0 tracking-[-0.4395px] whitespace-nowrap">5.0</p>
      </div>
    </div>
  );
}
...
function Score() {
  return (
    <div className="content-stretch flex gap-[32px] items-start relative shrink-0 w-full" data-name="score">
      <Container3 />
      <Container17 />
    </div>
  );
...
function Icon6() {
  return (
    <div className="relative size-[96px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 96 96">
        <g clipPath="url(#clip0_521_8168)" id="Icon">
          <path d={svgPaths.p30d75d80} id="Vector" stroke="var(--stroke-0, #E5E7EB)" strokeWidth="8.4" />
          <path d={svgPaths.p28c63380} id="Ellipse 1793" stroke="var(--stroke-0, #FDC700)" strokeLinecap="round" strokeWidth="8.4" />
        </g>
        <defs>
          <clipPath id="clip0_521_8168">
            <rect fill="white" height="96" width="96" />
          </clipPath>
        </defs>
      </svg>
...
function Icon8() {
  return (
    <div className="relative size-[96px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 96 96">
        <g clipPath="url(#clip0_521_8197)" id="Icon">
          <path d={svgPaths.p30d75d80} id="Vector" stroke="var(--stroke-0, #E5E7EB)" strokeWidth="8.4" />
        </g>
        <defs>
          <clipPath id="clip0_521_8197">
            <rect fill="white" height="96" width="96" />
          </clipPath>
        </defs>
      </svg>
  ...
  return (
    <div className="h-[28px] relative shrink-0 w-[27.742px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        ...
        <div className="absolute flex h-[70.587px] items-center justify-center left-[13.87px] top-[-22px] w-[43px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
          <div className="-rotate-90 flex-none">
            <div className="h-[43px] relative w-[70.587px]">
              <div className="absolute inset-[-9.77%_-5.95%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 78.9872 51.4">
                  <path d={svgPaths.p1f4b0300} id="Ellipse 1794" stroke="var(--stroke-0, #FDC700)" strokeLinecap="round" strokeWidth="8.4" />
                </svg>
              </div>
            </div>
          </div>
...
export default function EstrellasOn() {
  return (
    <div className="bg-white relative rounded-[12px] size-full" data-name="estrellas ON">
