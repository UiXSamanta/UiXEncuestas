import svgPaths from "./svg-211h20ael3";
...
function Text() {
  return (
    <div className="absolute h-[24px] left-[47px] top-[18px] w-[86.945px]" data-name="Text">
...
function Button() {
  return (
    <div className="h-[60px] relative rounded-[14px] shrink-0 w-full" data-name="Button">
...
function Text2() {
  return (
    <div className="absolute h-[24px] left-[47px] top-[18px] w-[54.414px]" data-name="Text">
...
export default function RespuestaRankingDefault() {
  return (
    <div className="bg-white drop-shadow-[0px_10px_7.5px_rgba(0,0,0,0.1),0px_4px_3px_rgba(0,0,0,0.1)] relative rounded-[16px] size-full" data-name="Respuesta Ranking / Default">
      <Container />
      <Heading />
      <Container1 />
      <Container2 />
