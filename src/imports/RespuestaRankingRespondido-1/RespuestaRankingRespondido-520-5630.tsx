import svgPaths from "./svg-1n4n0hqtss";
...
function Heading() {
  return (
    <div className="absolute h-[72px] leading-[36px] left-[40px] not-italic text-[#101828] top-[88px] tracking-[0.3955px] w-[592px]" data-name="Heading 2">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold left-0 text-[30px] top-0 w-[592px]">¿En qué eres mejor?</p>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal left-0 text-[20px] top-[42px] w-[592px]">Arrastra y deja hasta arriba el favorito</p>
    </div>
  );
}
...
function Text() {
  return (
    <div className="absolute h-[24px] left-[47px] top-[18px] w-[52.711px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#165dfc] text-[16px] top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">Escribir</p>
    </div>
  );
}
      ...
      <div className="absolute inset-[45.83%_58.33%_45.83%_33.33%]" data-name="Vector">
        <div className="absolute inset-[-50%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3.33333 3.33333">
            <path d={svgPaths.p3815c300} id="Vector" stroke="var(--stroke-0, #165DFC)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          </svg>
        </div>
      </div>
...
function Button1() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[12px] size-[20px] top-[19px]" data-name="Button">
      <Icon />
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-[#e8efff] h-[60px] relative rounded-[14px] shrink-0 w-full" data-name="Button">
      <div aria-hidden="true" className="absolute border-2 border-[#165dfc] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <Text />
      <Button1 />
    </div>
  );
...
function Text1() {
  return (
    <div className="absolute h-[24px] left-[47px] top-[18px] w-[52.711px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#165dfc] text-[16px] top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">Leer</p>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="absolute h-[24px] left-[47px] top-[18px] w-[52.711px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#165dfc] text-[16px] top-[-0.5px] tracking-[-0.3125px] whitespace-nowrap">Hablar</p>
    </div>
  );
}
...
function Button7() {
  return (
    <div className="bg-[#155dfc] flex-[288_0_0] h-[52px] min-w-px relative rounded-[10px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Container2() {
  return (
    <div className="absolute bottom-[40px] content-stretch flex gap-[12px] h-[77px] items-start left-[40px] pt-[25px] right-[40px]" data-name="Container">
...
export default function RespuestaRankingRespondido() {
  return (
    <div className="bg-white drop-shadow-[0px_10px_7.5px_rgba(0,0,0,0.1),0px_4px_3px_rgba(0,0,0,0.1)] relative rounded-[16px] size-full" data-name="Respuesta Ranking / Respondido">
      <Container />
      <Heading />
      <Container1 />
      <Container2 />
