  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-background flex flex-col">
      <div className="flex-1 flex items-center justify-center p-6">
        {/* Card */}
        <div className="bg-white dark:bg-card rounded-2xl shadow-lg p-10 md:p-14 max-w-md w-full text-center">
          {/* Check icon */}
          ...
          {/* Title */}
          <h2 className="text-2xl font-bold text-gray-900 dark:text-foreground mb-3">{titulo}</h2>

          {/* Message */}
          <p className="text-gray-500 dark:text-muted-foreground mb-7">{mensaje}<br/><br/></p>
          {/* Response ID */}
          {/* {responseId && (
