...
export function SurveyError() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-background flex items-center justify-center p-4">
      <div className="bg-white dark:bg-card rounded-2xl shadow-lg p-8 md:p-12 max-w-md w-full text-center">
        <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-6">
          <AlertCircle className="w-8 h-8 text-red-600" />
        </div>
        
        <h2 className="text-2xl font-bold text-gray-900 dark:text-foreground mb-3">
          {currentError.title}
        </h2>
        ...
        {surveyId && (
          <div className="text-xs text-gray-500 dark:text-muted-foreground font-mono bg-gray-50 dark:bg-muted p-3 rounded border border-gray-200 dark:border-border mb-6">
            ID: {surveyId}
          </div>
        )}
