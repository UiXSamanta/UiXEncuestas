...
export function AdminRequestPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#597AFF]/10 via-[#8C59FE]/10 to-[#EBEEF4] flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-[440px] px-[24px] py-[40px] text-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#597AFF]/10 via-[#8C59FE]/10 to-[#EBEEF4] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-[480px] px-[24px] py-[32px]">
        ...
        <div className="flex flex-col items-start gap-3 mb-[24px]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-semibold text-[20px] leading-[28px] tracking-[-0.4492px] text-[#303C48]">Solicitar acceso de admin</h1>
              <p className="text-[13px] leading-[18px] text-[#81878E]">Revisaremos tu solicitud</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-[18px]">
          ...
          <div className="flex flex-col gap-[8px]">
            ...
            <textarea
              ...
              className="w-full px-[16px] py-[14px] rounded-[10px] border border-[#C3C5C9] text-[16px] text-[#303C48] placeholder:text-[#81878E] tracking-[-0.3125px] focus:outline-none focus:ring-2 focus:ring-[#8C59FE] focus:border-transparent transition-all resize-none"
            />
          </div>
        ...
        <div className="mt-6 pt-5 border-t border-[#EBEEF4] text-center">
          <p className="text-[12px] text-[#81878E]">
            La solicitud será notificada a{' '}
            <span className="font-medium text-[#5C6671]">samanta.camacho@upax.com.mx</span>
          </p>
        </div>
      </div>
    </div>
